...
export interface FilePickerPlugin {
     ...
     * @since 0.6.0
     */
    convertMovToMp4(options: ConvertHeicToJpegOptions): Promise<ConvertHeicToJpegResult>;
    /**
...
export interface ConvertMovToMp4Options {
    /**
     * The path of the QuickTime video.
     *
 ...
 * @since 6.2.0
 */
export interface ConvertMovToMp4Result {
    /**
     * The path of the converted Mp4 image.
     *
     * @example '/path/to/video.mp4'
     * @since 6.2.0
     */
